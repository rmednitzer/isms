...
doc_id: REC-2026-711
doc_type: record
title: "Implementation statement for A.7.11 Supporting utilities"
revision: 1
status: draft
approved_date: null
approved_by: null
...
# Implementation statement for A.7.11 Supporting utilities

**REC-2026-711 Revision 1 (DRAFT)**

*Status: draft. Owner: role:ISMS-Manager. Next review: 2027-01-01.*

## Control

A.7.11 Supporting utilities (theme: physical).

## Implementation

Equipment is protected from power failures and other disruptions caused by failures of supporting utilities, per P-008.
