...
doc_id: REC-2026-832
doc_type: record
title: "Implementation statement for A.8.32 Change management"
revision: 1
status: draft
approved_date: null
approved_by: null
...
# Implementation statement for A.8.32 Change management

**REC-2026-832 Revision 1 (DRAFT)**

*Status: draft. Owner: role:ISMS-Manager. Next review: 2027-01-01.*

## Control

A.8.32 Change management (theme: technological).

## Implementation

Changes to information processing facilities and systems are subject to change management procedures, per P-007.
