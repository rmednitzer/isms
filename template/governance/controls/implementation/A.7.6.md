...
doc_id: REC-2026-706
doc_type: record
title: "Implementation statement for A.7.6 Working in secure areas"
revision: 1
status: draft
approved_date: null
approved_by: null
...
# Implementation statement for A.7.6 Working in secure areas

**REC-2026-706 Revision 1 (DRAFT)**

*Status: draft. Owner: role:ISMS-Manager. Next review: 2027-01-01.*

## Control

A.7.6 Working in secure areas (theme: physical).

## Implementation

Security measures for working in secure areas are defined and applied, per P-008.
