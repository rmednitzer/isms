...
doc_id: REC-2026-807
doc_type: record
title: "Implementation statement for A.8.7 Protection against malware"
revision: 1
status: draft
approved_date: null
approved_by: null
...
# Implementation statement for A.8.7 Protection against malware

**REC-2026-807 Revision 1 (DRAFT)**

*Status: draft. Owner: role:ISMS-Manager. Next review: 2027-01-01.*

## Control

A.8.7 Protection against malware (theme: technological).

## Implementation

Protection against malware is implemented and supported by user awareness, per P-013.
